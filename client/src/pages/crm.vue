<template>
    <div class="page">
        <block v-if="Global">
            <div>
                <img :src="Global.banner" alt="banner" mode="widthFix" class="banner">
            </div>
            <div class="page__bd">
                <div class="weui-grids">
                <block v-for="(item,index) in Global.list" :key="index">
        ...
        <block v-else>
            <div class="flex flex-align-center flex-pack-center" style="height:100vh">
                <div>加载中...</div>
            </div>
        </block>
    </div>
